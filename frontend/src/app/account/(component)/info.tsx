...
// import { Briefcase, Camera, Edit, FileText, Link, Mail, NotepadText, Phone, UserIcon } from 'lucide-react';
...
//                         </div>
//                         {/* edit option for you profile pic */}
//                         {(<>
//                             isYourAccount && <Button variant={"secondary"} size={"icon"} onClick={handleClick} className='absolute bottom-0 right-0'>
//                                 <Camera size={18}/>
//                             </Button>
...
//                         {/* Edit button */}
//                         {isYourAccount&& (<Button variant={"outline"} size={"icon"} onClick={handleEditClick} className='h-8 w-8'>
//                           <Edit size={16}/>
//                         </Button>)}
...
//                     <div className='h-10 w-10 rounded-full jusitfy-center'>
...
//                         <Input id='phone' type='number' placeholder='Enter you Phone Number' className='h-11' value={phoneNumber} onChange={(e)=>setPhoneNumber(e.target.name)}/>
...
const Info: React.FC<AccountProps> = ({
  ...
  const [phoneNumber, setPhoneNumber] = useState("");
  const [bio, setBio] = useState("");
  console.log("USER IN INFO COMPONENT:", user);
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-70">
                          Subscribe to unlock premium features and get noticed by top employers!

                        </p>
                      </div>
                      <Button className="gap-2" onClick={()=>router.push("/subscribe")}><Crown size={20} className="text-blue-600"/>Subscribe Now</Button>
                      </div>
                      </>): new Date(user.subscription).getTime()>Date.now()? <div className="flex items-center justify-between flex-wrap gap-4">
                        <div>
                          ...
                          <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-green-700 text-white font-medium">
